    ...
    <div>
      ...
      <div className="mt-3 grid grid-cols-2 gap-2">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-xl border border-lime-400/30 bg-lime-400/10 px-3 py-2 text-xs font-semibold text-lime-300 transition hover:bg-lime-400/20"
        >
          <Camera size={16} />
          Cámara
        </button>
